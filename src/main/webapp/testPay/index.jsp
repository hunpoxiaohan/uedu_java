		...
		<form name=alipayment action=alipay.trade.page.pay.jsp method=post
			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					<dt>商户订单号 ：</dt>
					<dd>
						<input id="WIDout_trade_no" name="WIDout_trade_no" value="${order.orderId}"/>
					</dd>
					<hr class="one_line">
					<dt>订单名称 ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject" value="${order.courseName}"/>
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
...
<script language="javascript">
	...
	// 	// document.getElementById("WIDtotal_amount").value = "9999";
	// }
	// GetDateNow();
</script>
</html>